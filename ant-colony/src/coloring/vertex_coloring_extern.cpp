...
extern "C" 
{ 
  int vertex_coloring(int N, int edge[128][128], int C, int PRINTOUT)
  { 
    //Read Graph		
    if(PRINTOUT) cout<<"Vertex Coloring Algorithm."<<endl; 
    int n, i, j, k, K, p, q, r, s, min, counter=0; 
		int ITER_TO_STOP=100;
    ...
    if(PRINTOUT) cout<<"Graph has N = "<<N<<" vertices."<<endl; 
    ...
    bool found=false; 
    if(PRINTOUT) cout<<"Finding Vertex Colorings..."<<endl; 
    min=n+1; 
      ...
      { 
        ...
        if(s<=k) 
          { 
            ...
            outfile<<endl; 
            if(PRINTOUT) cout<<"Vertex Coloring Size: "<<n-s<<endl; 
    ...
    //Pairwise Intersections
		...
		///////////////////////////////////////////////////////
		///////////////////////////////////////////////////////
		/* ITER_TO_STOP = covers.size()*1.05;
		cout<<"Cover Size: " << covers.size() << endl; */
		///////////////////////////////////////////////////////
		///////////////////////////////////////////////////////
    ...
    for(p=0; p<covers.size(); p++) 
      { 
        ...
        for(q=p+1; q<covers.size(); q++) 
          { 
            if(found) break; 
						/* if(counter>ITER_TO_STOP) return 0; */
            counter++; 
						if(PRINTOUT) cout<<counter<<". ";
						outfile<<counter<<". "; 
            vector<int> cover=allcover; 
			...
			{
					if(PRINTOUT) cout<<"Could not find complete Vertex Coloring using at most "<<C<<" colors."<<endl 
